...
const PenjemputanForm = () => {
  ...
  async function requestSubmitHandler(event) {
    ...
    if (beratValue < 10) {
      setIsSubmitting(false);
      toast.error("Berat masih kurang dari 10kg");
      return;
    }

    if (picture === "") {
      setIsSubmitting(false);
      toast.error("Silahkan foto sampah");
      return;
    }
        ...
        <Card sx={{ minWidth: 275 }} variant="outlined">
          <CardContent>
            ...
            <TextField
              ...
              error={beratHasError}
              helperText={beratHasError && "Berat sampah tidak boleh kosong"}
              fullWidth
            />
            <TextField
              disabled
        ...
        <div className="form-penjemputan-button">
          ...
          >
            <Grid item xs={12}>
              ...
              {isSubmitting && <Button variant="contained">Loading... </Button>}
            </Grid>
            <Grid item xs={12}>
              <Link to="/">
